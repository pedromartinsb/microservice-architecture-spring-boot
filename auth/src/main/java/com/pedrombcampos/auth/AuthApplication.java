package com.pedrombcampos.auth;
...
import com.pedrombcampos.auth.entity.Permission;
import com.pedrombcampos.auth.entity.User;
import com.pedrombcampos.auth.repository.PermissionRepository;
import com.pedrombcampos.auth.repository.UserRepository;
...
public class AuthApplication {
	...
	private void initUsers(UserRepository userRepository, PermissionRepository permissionRepository,
		...
		User admin = new User();
		admin.setUserName("pedrombcampos");
		...
		User find = userRepository.findByUserName("pedrombcampos");
		if (find == null) {
